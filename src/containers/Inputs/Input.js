	...
	render() {
		...
		return (<Fragment>
			...
			<div className={mainclass}>
				<input type={this.props.type} name={this.props.name} autoComplete={autoComplete} className={inputclass} value={this.state.value} disabled={this.props.disabled} onChange={(e) => this.change(e.currentTarget.value)} onKeyPress={(e) => this.enter(e)} id={this.props.id} tabIndex={this.props.tabindex} placeholder={this.props.placeholder} ></input>
